...
package com.luck.slideleftfinish.weight;
/*
 * Tencent is pleased to support the open source community by making QMUI_Android available.
 *
 * Copyright (C) 2017-2018 THL A29 Limited, a Tencent company. All rights reserved.
...
import com.luck.slideleftfinish.R;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        Log.d(TAG, "onIntercepTouchEvent --" + event.getAction());
        if (preventSwipeBack(event)) {
            Log.d(TAG, "onIntercepTouchEvent --preventSwipeBack" + event.getAction());
            return false;
        }
        try {
            boolean result = mDragHelper.shouldInterceptTouchEvent(event);
            Log.d(TAG, "onIntercepTouchEvent --result" + result + "  " + event.getAction());
            return result;
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View view, int i) {
            Log.d(TAG, "tryCaptureView-mEdgeFlag:"+mEdgeFlag+"  i:"+i);
            boolean ret = canSwipeBack();
            if (ret) {
            ...
            Log.d(TAG, "ret:" + ret + "  mTrackingEdge:" + mTrackingEdge + "  directionCheck:" + directionCheck);
